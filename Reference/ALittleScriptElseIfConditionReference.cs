...
namespace ALittle
{
    public class ALittleScriptElseIfConditionReference : ALittleScriptReferenceTemplate<ALittleScriptElseIfConditionElement>
    {
        public ALittleScriptElseIfConditionReference(ABnfElement element) : base(element) { }
