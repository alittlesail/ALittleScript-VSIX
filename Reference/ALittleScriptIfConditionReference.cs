...
namespace ALittle
{
    public class ALittleScriptIfConditionReference : ALittleScriptReferenceTemplate<ALittleScriptIfConditionElement>
    {
        public ALittleScriptIfConditionReference(ABnfElement element) : base(element) { }
