...
namespace ALittle
{
    public class ALittleScriptWhileConditionReference : ALittleScriptReferenceTemplate<ALittleScriptWhileConditionElement>
    {
        public ALittleScriptWhileConditionReference(ABnfElement element) : base(element) { }
