...
namespace ALittle
{
    public class ALittleScriptClassMethodDecReference : ALittleScriptReferenceTemplate<ALittleScriptClassMethodDecElement>
    {
        public ALittleScriptClassMethodDecReference(ABnfElement element) : base(element) { }
        ...
        public override ABnfGuessError CheckError()
        {
            ...
            if (parent == null)
                return new ABnfGuessError(m_element, "ALittleScriptClassMethodDecElement的父节点不是ALittleScriptClassElementDecElement");
