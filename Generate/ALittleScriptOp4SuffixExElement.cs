...
namespace ALittle
{
	public class ALittleScriptOp4SuffixExElement : ABnfNodeElement
	{
		public ALittleScriptOp4SuffixExElement(ABnfFactory factory, ABnfFile file, int line, int col, int offset, string type)
