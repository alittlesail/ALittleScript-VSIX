...
namespace ALittle
{
	public class ALittleScriptNumberElement : ABnfNodeElement
	{
		public ALittleScriptNumberElement(ABnfFactory factory, ABnfFile file, int line, int col, int offset, string type)
