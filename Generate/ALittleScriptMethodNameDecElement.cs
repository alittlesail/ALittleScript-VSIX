...
namespace ALittle
{
	public class ALittleScriptMethodNameDecElement : ABnfNodeElement
	{
		public ALittleScriptMethodNameDecElement(ABnfFactory factory, ABnfFile file, int line, int col, int offset, string type)
