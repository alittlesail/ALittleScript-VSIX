...
namespace ALittle
{
	public class ALittleScriptOp6SuffixExElement : ABnfNodeElement
	{
		public ALittleScriptOp6SuffixExElement(ABnfFactory factory, ABnfFile file, int line, int col, int offset, string type)
