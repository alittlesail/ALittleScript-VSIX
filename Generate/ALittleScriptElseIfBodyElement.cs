...
namespace ALittle
{
	public class ALittleScriptElseIfBodyElement : ABnfNodeElement
	{
		public ALittleScriptElseIfBodyElement(ABnfFactory factory, ABnfFile file, int line, int col, int offset, string type)
