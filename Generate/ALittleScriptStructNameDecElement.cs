...
namespace ALittle
{
	public class ALittleScriptStructNameDecElement : ABnfNodeElement
	{
		public ALittleScriptStructNameDecElement(ABnfFactory factory, ABnfFile file, int line, int col, int offset, string type)
