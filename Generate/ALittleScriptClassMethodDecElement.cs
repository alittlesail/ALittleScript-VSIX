...
namespace ALittle
{
	public class ALittleScriptClassMethodDecElement : ABnfNodeElement
	{
		public ALittleScriptClassMethodDecElement(ABnfFactory factory, ABnfFile file, int line, int col, int offset, string type)
