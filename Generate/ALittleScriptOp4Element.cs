...
namespace ALittle
{
	public class ALittleScriptOp4Element : ABnfNodeElement
	{
		public ALittleScriptOp4Element(ABnfFactory factory, ABnfFile file, int line, int col, int offset, string type)
