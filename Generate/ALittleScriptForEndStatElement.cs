...
namespace ALittle
{
	public class ALittleScriptForEndStatElement : ABnfNodeElement
	{
		public ALittleScriptForEndStatElement(ABnfFactory factory, ABnfFile file, int line, int col, int offset, string type)
