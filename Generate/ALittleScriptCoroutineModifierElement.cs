...
namespace ALittle
{
	public class ALittleScriptCoroutineModifierElement : ABnfNodeElement
	{
		public ALittleScriptCoroutineModifierElement(ABnfFactory factory, ABnfFile file, int line, int col, int offset, string type)
