...
namespace ALittle
{
	public class ALittleScriptAllTypeConstElement : ABnfNodeElement
	{
		public ALittleScriptAllTypeConstElement(ABnfFactory factory, ABnfFile file, int line, int col, int offset, string type)
