...
namespace ALittle
{
	public class ALittleScriptRegisterModifierElement : ABnfNodeElement
	{
		public ALittleScriptRegisterModifierElement(ABnfFactory factory, ABnfFile file, int line, int col, int offset, string type)
