...
namespace ALittle
{
	public class ALittleScriptElseIfConditionElement : ABnfNodeElement
	{
		public ALittleScriptElseIfConditionElement(ABnfFactory factory, ABnfFile file, int line, int col, int offset, string type)
