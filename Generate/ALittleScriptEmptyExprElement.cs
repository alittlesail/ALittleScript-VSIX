...
namespace ALittle
{
	public class ALittleScriptEmptyExprElement : ABnfNodeElement
	{
		public ALittleScriptEmptyExprElement(ABnfFactory factory, ABnfFile file, int line, int col, int offset, string type)
