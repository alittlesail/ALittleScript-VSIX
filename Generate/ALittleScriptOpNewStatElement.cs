...
namespace ALittle
{
	public class ALittleScriptOpNewStatElement : ABnfNodeElement
	{
		public ALittleScriptOpNewStatElement(ABnfFactory factory, ABnfFile file, int line, int col, int offset, string type)
