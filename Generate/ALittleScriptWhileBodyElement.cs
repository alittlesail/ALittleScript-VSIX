...
namespace ALittle
{
	public class ALittleScriptWhileBodyElement : ABnfNodeElement
	{
		public ALittleScriptWhileBodyElement(ABnfFactory factory, ABnfFile file, int line, int col, int offset, string type)
