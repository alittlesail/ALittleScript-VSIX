...
namespace ALittle
{
	public class ALittleScriptIfConditionElement : ABnfNodeElement
	{
		public ALittleScriptIfConditionElement(ABnfFactory factory, ABnfFile file, int line, int col, int offset, string type)
