...
namespace ALittle
{
	public class ALittleScriptOp7Element : ABnfNodeElement
	{
		public ALittleScriptOp7Element(ABnfFactory factory, ABnfFile file, int line, int col, int offset, string type)
