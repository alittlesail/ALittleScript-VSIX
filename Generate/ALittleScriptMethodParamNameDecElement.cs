...
namespace ALittle
{
	public class ALittleScriptMethodParamNameDecElement : ABnfNodeElement
	{
		public ALittleScriptMethodParamNameDecElement(ABnfFactory factory, ABnfFile file, int line, int col, int offset, string type)
