...
namespace ALittle
{
	public class ALittleScriptEnumNameDecElement : ABnfNodeElement
	{
		public ALittleScriptEnumNameDecElement(ABnfFactory factory, ABnfFile file, int line, int col, int offset, string type)
