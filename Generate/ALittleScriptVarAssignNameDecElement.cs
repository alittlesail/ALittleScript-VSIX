...
namespace ALittle
{
	public class ALittleScriptVarAssignNameDecElement : ABnfNodeElement
	{
		public ALittleScriptVarAssignNameDecElement(ABnfFactory factory, ABnfFile file, int line, int col, int offset, string type)
