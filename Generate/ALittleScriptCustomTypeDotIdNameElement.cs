...
namespace ALittle
{
	public class ALittleScriptCustomTypeDotIdNameElement : ABnfNodeElement
	{
		public ALittleScriptCustomTypeDotIdNameElement(ABnfFactory factory, ABnfFile file, int line, int col, int offset, string type)
