...
namespace ALittle
{
	public class ALittleScriptIdElement : ABnfNodeElement
	{
		public ALittleScriptIdElement(ABnfFactory factory, ABnfFile file, int line, int col, int offset, string type)
