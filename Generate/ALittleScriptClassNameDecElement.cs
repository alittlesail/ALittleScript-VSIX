...
namespace ALittle
{
	public class ALittleScriptClassNameDecElement : ABnfNodeElement
	{
		public ALittleScriptClassNameDecElement(ABnfFactory factory, ABnfFile file, int line, int col, int offset, string type)
