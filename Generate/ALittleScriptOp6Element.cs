...
namespace ALittle
{
	public class ALittleScriptOp6Element : ABnfNodeElement
	{
		public ALittleScriptOp6Element(ABnfFactory factory, ABnfFile file, int line, int col, int offset, string type)
