...
namespace ALittle
{
	public class ALittleScriptMethodBodyDecElement : ABnfNodeElement
	{
		public ALittleScriptMethodBodyDecElement(ABnfFactory factory, ABnfFile file, int line, int col, int offset, string type)
