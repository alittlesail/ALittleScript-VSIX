...
namespace ALittle
{
	public class ALittleScriptMethodParamTailDecElement : ABnfNodeElement
	{
		public ALittleScriptMethodParamTailDecElement(ABnfFactory factory, ABnfFile file, int line, int col, int offset, string type)
