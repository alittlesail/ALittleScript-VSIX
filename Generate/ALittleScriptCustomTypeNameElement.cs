...
namespace ALittle
{
	public class ALittleScriptCustomTypeNameElement : ABnfNodeElement
	{
		public ALittleScriptCustomTypeNameElement(ABnfFactory factory, ABnfFile file, int line, int col, int offset, string type)
