...
namespace ALittle
{
	public class ALittleScriptReflectValueStatElement : ABnfNodeElement
	{
		public ALittleScriptReflectValueStatElement(ABnfFactory factory, ABnfFile file, int line, int col, int offset, string type)
