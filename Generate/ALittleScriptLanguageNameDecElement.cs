...
namespace ALittle
{
	public class ALittleScriptLanguageNameDecElement : ABnfNodeElement
	{
		public ALittleScriptLanguageNameDecElement(ABnfFactory factory, ABnfFile file, int line, int col, int offset, string type)
