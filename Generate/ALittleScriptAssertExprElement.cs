...
namespace ALittle
{
	public class ALittleScriptAssertExprElement : ABnfNodeElement
	{
		public ALittleScriptAssertExprElement(ABnfFactory factory, ABnfFile file, int line, int col, int offset, string type)
