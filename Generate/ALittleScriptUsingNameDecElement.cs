...
namespace ALittle
{
	public class ALittleScriptUsingNameDecElement : ABnfNodeElement
	{
		public ALittleScriptUsingNameDecElement(ABnfFactory factory, ABnfFile file, int line, int col, int offset, string type)
