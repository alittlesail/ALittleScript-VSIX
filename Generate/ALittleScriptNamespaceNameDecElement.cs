...
namespace ALittle
{
	public class ALittleScriptNamespaceNameDecElement : ABnfNodeElement
	{
		public ALittleScriptNamespaceNameDecElement(ABnfFactory factory, ABnfFile file, int line, int col, int offset, string type)
