...
namespace ALittle
{
	public class ALittleScriptOp5SuffixEeElement : ABnfNodeElement
	{
		public ALittleScriptOp5SuffixEeElement(ABnfFactory factory, ABnfFile file, int line, int col, int offset, string type)
