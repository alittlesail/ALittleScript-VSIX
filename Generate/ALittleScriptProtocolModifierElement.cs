...
namespace ALittle
{
	public class ALittleScriptProtocolModifierElement : ABnfNodeElement
	{
		public ALittleScriptProtocolModifierElement(ABnfFactory factory, ABnfFile file, int line, int col, int offset, string type)
