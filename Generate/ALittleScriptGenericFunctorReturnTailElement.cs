...
namespace ALittle
{
	public class ALittleScriptGenericFunctorReturnTailElement : ABnfNodeElement
	{
		public ALittleScriptGenericFunctorReturnTailElement(ABnfFactory factory, ABnfFile file, int line, int col, int offset, string type)
