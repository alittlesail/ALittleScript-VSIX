...
namespace ALittle
{
	public class ALittleScriptOp1Element : ABnfNodeElement
	{
		public ALittleScriptOp1Element(ABnfFactory factory, ABnfFile file, int line, int col, int offset, string type)
