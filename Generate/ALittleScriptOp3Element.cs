...
namespace ALittle
{
	public class ALittleScriptOp3Element : ABnfNodeElement
	{
		public ALittleScriptOp3Element(ABnfFactory factory, ABnfFile file, int line, int col, int offset, string type)
