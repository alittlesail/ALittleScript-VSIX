...
namespace ALittle
{
	public class ALittleScriptPathsValueElement : ABnfNodeElement
	{
		public ALittleScriptPathsValueElement(ABnfFactory factory, ABnfFile file, int line, int col, int offset, string type)
