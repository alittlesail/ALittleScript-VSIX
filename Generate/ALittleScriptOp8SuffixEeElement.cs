...
namespace ALittle
{
	public class ALittleScriptOp8SuffixEeElement : ABnfNodeElement
	{
		public ALittleScriptOp8SuffixEeElement(ABnfFactory factory, ABnfFile file, int line, int col, int offset, string type)
