...
namespace ALittle
{
	public class ALittleScriptConstModifierElement : ABnfNodeElement
	{
		public ALittleScriptConstModifierElement(ABnfFactory factory, ABnfFile file, int line, int col, int offset, string type)
