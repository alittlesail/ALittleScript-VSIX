...
namespace ALittle
{
	public class ALittleScriptPropertyValueCustomTypeElement : ABnfNodeElement
	{
		public ALittleScriptPropertyValueCustomTypeElement(ABnfFactory factory, ABnfFile file, int line, int col, int offset, string type)
