...
namespace ALittle
{
	public class ALittleScriptOp3SuffixExElement : ABnfNodeElement
	{
		public ALittleScriptOp3SuffixExElement(ABnfFactory factory, ABnfFile file, int line, int col, int offset, string type)
