...
namespace ALittle
{
	public class ALittleScriptGenericListTypeElement : ABnfNodeElement
	{
		public ALittleScriptGenericListTypeElement(ABnfFactory factory, ABnfFile file, int line, int col, int offset, string type)
