...
namespace ALittle
{
	public class ALittleScriptOp2Element : ABnfNodeElement
	{
		public ALittleScriptOp2Element(ABnfFactory factory, ABnfFile file, int line, int col, int offset, string type)
