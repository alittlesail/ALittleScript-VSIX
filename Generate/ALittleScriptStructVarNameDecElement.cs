...
namespace ALittle
{
	public class ALittleScriptStructVarNameDecElement : ABnfNodeElement
	{
		public ALittleScriptStructVarNameDecElement(ABnfFactory factory, ABnfFile file, int line, int col, int offset, string type)
