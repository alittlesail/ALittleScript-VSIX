...
namespace ALittle
{
	public class ALittleScriptPropertyValueBracketValueElement : ABnfNodeElement
	{
		public ALittleScriptPropertyValueBracketValueElement(ABnfFactory factory, ABnfFile file, int line, int col, int offset, string type)
