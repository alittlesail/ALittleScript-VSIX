...
namespace ALittle
{
	public class ALittleScriptOp5Element : ABnfNodeElement
	{
		public ALittleScriptOp5Element(ABnfFactory factory, ABnfFile file, int line, int col, int offset, string type)
