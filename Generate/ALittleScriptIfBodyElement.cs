...
namespace ALittle
{
	public class ALittleScriptIfBodyElement : ABnfNodeElement
	{
		public ALittleScriptIfBodyElement(ABnfFactory factory, ABnfFile file, int line, int col, int offset, string type)
