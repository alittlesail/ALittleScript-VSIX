...
namespace ALittle
{
	public class ALittleScriptClassStaticDecElement : ABnfNodeElement
	{
		public ALittleScriptClassStaticDecElement(ABnfFactory factory, ABnfFile file, int line, int col, int offset, string type)
