...
namespace ALittle
{
	public class ALittleScriptCoroutineStatElement : ABnfNodeElement
	{
		public ALittleScriptCoroutineStatElement(ABnfFactory factory, ABnfFile file, int line, int col, int offset, string type)
