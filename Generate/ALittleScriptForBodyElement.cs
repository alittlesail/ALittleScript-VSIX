...
namespace ALittle
{
	public class ALittleScriptForBodyElement : ABnfNodeElement
	{
		public ALittleScriptForBodyElement(ABnfFactory factory, ABnfFile file, int line, int col, int offset, string type)
