...
namespace ALittle
{
	public class ALittleScriptNativeModifierElement : ABnfNodeElement
	{
		public ALittleScriptNativeModifierElement(ABnfFactory factory, ABnfFile file, int line, int col, int offset, string type)
