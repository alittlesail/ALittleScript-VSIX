...
namespace ALittle
{
	public class ALittleScriptTemplateNameDecElement : ABnfNodeElement
	{
		public ALittleScriptTemplateNameDecElement(ABnfFactory factory, ABnfFile file, int line, int col, int offset, string type)
