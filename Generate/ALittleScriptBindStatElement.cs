...
namespace ALittle
{
	public class ALittleScriptBindStatElement : ABnfNodeElement
	{
		public ALittleScriptBindStatElement(ABnfFactory factory, ABnfFile file, int line, int col, int offset, string type)
