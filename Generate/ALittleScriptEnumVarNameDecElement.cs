...
namespace ALittle
{
	public class ALittleScriptEnumVarNameDecElement : ABnfNodeElement
	{
		public ALittleScriptEnumVarNameDecElement(ABnfFactory factory, ABnfFile file, int line, int col, int offset, string type)
