...
namespace ALittle
{
	public class ALittleScriptTemplateConstElement : ABnfNodeElement
	{
		public ALittleScriptTemplateConstElement(ABnfFactory factory, ABnfFile file, int line, int col, int offset, string type)
