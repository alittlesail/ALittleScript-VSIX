...
namespace ALittle
{
	public class ALittleScriptBlockCommentElement : ABnfNodeElement
	{
		public ALittleScriptBlockCommentElement(ABnfFactory factory, ABnfFile file, int line, int col, int offset, string type)
