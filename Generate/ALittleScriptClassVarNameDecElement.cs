...
namespace ALittle
{
	public class ALittleScriptClassVarNameDecElement : ABnfNodeElement
	{
		public ALittleScriptClassVarNameDecElement(ABnfFactory factory, ABnfFile file, int line, int col, int offset, string type)
