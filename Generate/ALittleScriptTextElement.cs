...
namespace ALittle
{
	public class ALittleScriptTextElement : ABnfNodeElement
	{
		public ALittleScriptTextElement(ABnfFactory factory, ABnfFile file, int line, int col, int offset, string type)
