...
namespace ALittle
{
	public class ALittleScriptPropertyValueThisTypeElement : ABnfNodeElement
	{
		public ALittleScriptPropertyValueThisTypeElement(ABnfFactory factory, ABnfFile file, int line, int col, int offset, string type)
