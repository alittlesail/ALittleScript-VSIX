...
namespace ALittle
{
	public class ALittleScriptOp7SuffixEeElement : ABnfNodeElement
	{
		public ALittleScriptOp7SuffixEeElement(ABnfFactory factory, ABnfFile file, int line, int col, int offset, string type)
