...
namespace ALittle
{
	public class ALittleScriptOpAssignElement : ABnfNodeElement
	{
		public ALittleScriptOpAssignElement(ABnfFactory factory, ABnfFile file, int line, int col, int offset, string type)
