...
namespace ALittle
{
	public class ALittleScriptOp8Element : ABnfNodeElement
	{
		public ALittleScriptOp8Element(ABnfFactory factory, ABnfFile file, int line, int col, int offset, string type)
